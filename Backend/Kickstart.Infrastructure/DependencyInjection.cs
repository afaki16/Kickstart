...
using Kickstart.Infrastructure.Identity;
using Kickstart.Infrastructure.Repositories;
using Kickstart.Infrastructure.Services;
using Kickstart.Infrastructure.Authorization;
...
namespace Kickstart.Infrastructure
{
